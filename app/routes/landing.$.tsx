...
Click **BUY NOW** to uncover the truth behind the idol and its deadly secrets!`,
    ...
    },
    {
      ...
      longDescription: `When Paul Harley, a brilliant criminologist known for his unrelenting pursuit of truth, is called to investigate a string of chilling events in a quiet English countryside, he enters a world steeped in whispers of the macabre. 
...
Click BUY NOW to immerse yourself in a tale that will haunt your dreams and keep you turning pages deep into the night!`,
    ...
    },
    {
      ...
      longDescription: `When a package containing $40,000 disappears under mysterious circumstances, the Adams Express Company turns to one man: Allan Pinkerton, the legendary detective who has never met a case he couldn't crack.
...
Dive into this *Gothic masterpiece* where every shadow holds a story, and every revelation could shatter lives. Click **BUY** now to uncover the chilling twists of **THE DEAD SECRET**!`,
  ...
  // Determine cross-link for print/ebook
  const isEbook = variant.id.includes('ebook');
  let crossLinkHref = '';
  let crossLinkText = '';
  if (isEbook) {
    // e.g. 33bt-ebook-a -> 33bt-a5-a
