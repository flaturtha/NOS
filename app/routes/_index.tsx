...
export const meta: MetaFunction = () => [
  { title: "Vintage Mystery Sampler Bundle | Tales of Murder Press" },
  { name: "description", content: "Rediscover the golden age of detective fiction with five forgotten classics, beautifully reborn in a bookshelf-ready paperback collection. Mobile-first, senior-friendly, and 100% satisfaction guaranteed." },
];
...
export default function Index() {
    ...
    const handleScroll = () => {
      if (bottomCTARef.current) {
        ...
        if (readyHeadline) {
          ...
          // Fade out when headline is in lower half of viewport
  ...
  return (
    <div className="min-h-screen bg-white text-black" style={{ fontSize: "18px", lineHeight: "1.7" }}>
      ...
      {/* Lightbox Modal for Book Details */}
      {selectedBook !== null && (
      ...
      <section className="relative">
        ...
        <div
          ...
          style={{ backgroundImage: "url('/heros/hero1.png')" }}
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="max-w-4xl mx-auto px-6 text-center text-white">
              {/* Removed logo from here, only headline remains */}
        ...
        {/* Vertically balanced headline, flourish, and subheadline */}
        <div className="max-w-4xl mx-auto px-6 flex flex-col items-center text-left mt-4 md:mt-12 gap-y-4 md:gap-y-8">
          <p className="text-lg md:text-2xl font-bold text-[#242424] text-left w-full mb-8">
            Rediscover the golden age of detective fiction with five forgotten classics, beautifully reborn in a bookshelf-ready paperback collection.
          </p>
          <img src="/flourish.svg" alt="Decorative flourish" className="w-48 md:w-80 h-auto" />
        </div>
        {/* Offer section below hero */}
        <div className="px-6 py-12 md:py-16 text-center bg-white">
          <div className="max-w-4xl mx-auto">
            <div className="max-w-[65ch] mx-auto mb-8">
              <p className="text-xl leading-relaxed text-left mt-2 md:mt-4">
                Each book is designed for pure reading pleasure—easy to hold, printed in a clear, comfortable font, and yours to keep forever.
              </p>
            </div>
            <div className="bg-white shadow-xl border-2 border-[#8B0000] rounded-lg p-8 mb-8 max-w-md mx-auto">
              ...
              <div className="flex items-center justify-center gap-3 mb-6">
                ...
                <span className="bg-[#8B0000] text-white text-base px-3 py-1 rounded">Save 25%</span>
              </div>
            </div>
            ...
            <TrustSignals />
            {/* Remove extra divider here (keep only one divider after TrustSignals if needed) */}
          </div>
        </div>
      </section>
      ...
      <section className="px-6 py-16 bg-[#fdfcf9] border-t border-gray-200">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="max-w-[65ch] mx-auto mb-12">
            <p className="text-xl leading-relaxed text-left">
              We believe great stories deserve to be held in your hands. That's why we created the Vintage Mystery Sampler Bundle: five brilliant, forgotten classics, meticulously restored and published in a format designed for true reading enjoyment.
            </p>
          </div>
      ...
      {/* Reader Photo Section (placeholder) */}
      ...
      <section className="px-6 py-16 bg-[#fdfcf9] border-t border-gray-200">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="max-w-[65ch] mx-auto mb-12">
            <p className="text-xl leading-relaxed text-left">
              This hand-picked collection features five complete, standalone novels of suspense, detective work, and gothic mystery.
            </p>
          </div>
          <div className="space-y-8">
            {books.map((book, index) => (
              <div
                key={index}
                className="border border-gray-300 hover:border-[#8B0000] transition-colors shadow-sm bg-white rounded-lg p-8"
              >
      ...
      {/* Reader Profile Images Section (responsive, larger circles, fill row) */}
      <section className="px-6 py-12 bg-white border-t border-gray-200">
        <div className="max-w-4xl mx-auto">
          <div className="flex justify-between items-center gap-8 flex-wrap">
            {[1, 2, 3, 4, 5].map((i) => (
              <div
                key={i}
                className="w-24 h-24 bg-gray-300 rounded-full flex items-center justify-center text-gray-600 text-base border-2 border-gray-200 hidden sm:flex flex-grow"
            ...
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="w-20 h-20 bg-gray-300 rounded-full flex items-center justify-center text-gray-600 text-base border-2 border-gray-200 sm:hidden flex-grow"
      ...
      <section className="px-6 py-16 bg-[#fdfcf9] border-t border-gray-200">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 max-w-4xl mx-auto mb-8">
            <img src="/pass-the-mystery-on.png" alt="Person handing off books to a librarian" className="w-40 h-40 object-cover rounded-lg shadow mb-4 md:mb-0" />
          ...
          <div className="border-2 border-[#8B0000] bg-white mb-10 shadow-sm rounded-lg p-8">
      ...
      <section className="px-6 py-16 bg-[#fdfcf9] pb-32 border-t border-gray-200">
        <div className="max-w-4xl mx-auto text-center">
          <h2 data-cta-fade className="text-3xl md:text-4xl font-serif font-bold mb-8">
            Ready to Uncover Your Next Favorite Mystery?
          </h2>
          <div className="max-w-[65ch] mx-auto mb-12">
            <p className="text-xl leading-relaxed text-left">
              Get five timeless detective and mystery classics delivered to your door. The perfect collection for a cozy evening, a long weekend, or any time you crave a story that truly captivates.
            </p>
          </div>
